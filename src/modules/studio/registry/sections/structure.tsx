 ...
 * `templates/project-base/src/puck/sections/structure.tsx`.
 * Mismos nombres de componente, mismas props/fields/defaultProps (la
 * compatibilidad del Data JSON con el renderer del template es sagrada).
 *
