    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <nav className="hidden gap-6 text-sm font-medium md:flex">
          {p.links.map((l, i) => (
            <a key={i} href={l.href || "#"} className="hover:text-indigo-600">
              {l.label}
            </a>
          ))}
        </nav>
...
export const Footer: ComponentConfig<FooterProps> = {
  ...
  defaultProps: {
    brand: "Acme",
    tagline: "Hecho con secciones gobernadas.",
    tone: "dark",
    columns: [
      {
        title: "Producto",
      ...
      {
        title: "Empresa",
        links: [{ label: "Sobre nosotros", href: "#" }],
      },
    ],
    legal: "© 2026 Acme. Todos los derechos reservados.",
  },
  render: (p) => (
    <footer
      className={
