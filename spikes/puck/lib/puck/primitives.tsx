...
export const cardClass: Record<Tone, string> = {
  ...
  brand: "bg-indigo-600 border border-indigo-500",
};
  ...
  return (
    <p
      className={`mb-3 text-xs font-semibold uppercase tracking-widest ${
        tone === "brand" ? "text-indigo-200" : "text-indigo-600"
      }`}
    >
      {children}
    </p>
...
export const buttonClass: Record<ButtonStyle, string> = {
  primary:
    "inline-block rounded-md bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-indigo-500",
  secondary:
