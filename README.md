...
![Project Cockpit](docs/screenshots/cockpit.png)

![Studio index](docs/screenshots/studio-pages.png)

![Visual Studio](docs/screenshots/studio-editor.png)

![The single contextual assistant](docs/screenshots/assistant-skills.png)

![Launching a skill](docs/screenshots/assistant-model-cost.png)
