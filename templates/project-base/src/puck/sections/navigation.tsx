...
import { footerColumns, legalText, mainNav } from "@/generated/navigation";
import { mutedClass, type Tone } from "../primitives";

// Default props come from the codegen-owned navigation module (sitemap) and
// site.config.ts. They apply to NEW insertions in the editor; pages already
// composed keep the props stored in their Data JSON.
